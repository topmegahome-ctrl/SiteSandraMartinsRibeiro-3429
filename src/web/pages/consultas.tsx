...
const tiposConsulta = [
  { id: "familia",    slug: "direito-familia",    icon: "👨‍👩‍👧", title: "Direito da Família",     desc: "Divórcio, separação, regulação do exercício das responsabilidades parentais, alimentos e uniões de facto.", items: ["Divórcio por mútuo acordo","Divórcio litigioso","Regulação do poder paternal","Pensão de alimentos","União de facto"], duration: "60 min" },
  ...
  { id: "civil",      slug: "direito-civil",      icon: "📋", title: "Direito Civil",            desc: "Contratos, responsabilidade civil, cobranças de dívidas, ações declarativas e conflitos de vizinhança.", items: ["Incumprimento de contratos","Responsabilidade civil","Cobranças e injunções","Ação executiva","Conflitos de vizinhança","Danos e indemnizações"], duration: "60 min" },
  { id: "fiscal",     slug: "direito-fiscal-dividas", icon: "💰", title: "Direito Fiscal e Dívidas", desc: "Execuções fiscais, recursos de IRS/IRC, coimas tributárias e dívidas à Autoridade Tributária.", items: [], duration: "60 min" },
  { id: "comercial",  slug: "direito-comercial",  icon: "🤝", title: "Direito Comercial",         desc: "Contratos comerciais, constituição de sociedades, marcas, concorrência desleal e litígios entre empresas.", items: ["Contratos comerciais","Constituição de sociedades","Registo de marcas INPI","Concorrência desleal","Litígios comerciais","Propriedade industrial"], duration: "60 min" },
  { id: "outros",     slug: "outros-servicos",    icon: "⚖", title: "Outros Serviços",           desc: "Insolvência pessoal e empresarial, atos notariais, direito administrativo e seguros.", items: ["Insolvência pessoal / PERAP","Atos notariais e escrituras","Recursos administrativos","Reclamações a seguradoras","Procurações","Outros assuntos jurídicos"], duration: "60 min" },
];
